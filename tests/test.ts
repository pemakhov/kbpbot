...
describe('Redis', function () {
  describe('User manipulating', function () {
    it('should save user into redis', function () {
      return expect(redisDb.saveUser(testUser)).to.eventually.be.true;
    });
  ...
  describe('Phone manipulating', function () {
    it('should save phone into redis', function () {
      return expect(redisDb.savePhone(testPhone)).to.eventually.be.true;
    });
    ...
    it('should get null for not existing phone', function () {
      return expect(redisDb.getPhoneById(NOT_EXISTING_DATA_ID)).to.eventually.equal(null);
    });
  ...
  describe('Birthday manipulating', function () {
    it('should save birthday record into redis', function () {
      return expect(redisDb.saveBirthday(testBirthday)).to.eventually.be.true;
    });
    ...
    it('should get null for not existing birthday record', function () {
      return expect(redisDb.getBirthdayById(NOT_EXISTING_DATA_ID)).to.eventually.equal(null);
    });
